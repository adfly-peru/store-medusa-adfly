import { Text, Stack, Button, TextInput, Box, Space, Title, Divider, Select, Radio, Avatar, Badge, PasswordInput, Progress, Popover } from '@mantine/core'
      ...
      <form onSubmit={form.onSubmit((values) => updateStep(ACCOUNT_STEPS.COMPLETED))}>
        <Stack spacing="xs">
          ...
          <Popover opened={popoverOpened} position="bottom" width="target" transition="pop">
            ...
            <PasswordRequirement label="Incluye al menos 6 carácteres" meets={value.length > 5} />
              {checks}
            </Popover.Dropdown>
          </Popover>
